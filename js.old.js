...
function draw() {
    ...
    // Solar Sytem
    push();
    rotateY((millis()*level) / 2000);
    var planetteSoleil = createPlanet(1000, Soleil);
    pop();

    push();
    rotateY((millis()*level) / 144);
    translate(1100, 0, 0);
    rotateY((millis()*level) / 1000);
    var planetteMercure = createPlanet(18, Mercure);
    pop();

    push();
    rotateY((millis()*level) / 372);
    translate(1200, 0, 0);
    rotateY((millis()*level) / -1000);
